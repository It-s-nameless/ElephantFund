...
<nav class="navbar navbar-expand-lg navbar-light">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="Fund">基金产品</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="FundBuy">基金导购</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="#">投资服务</a>
			</li>
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="UserInfo">个人中心</a> <a
						class="dropdown-item" href="#">客服中心</a>
